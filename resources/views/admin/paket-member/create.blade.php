<form action="{{ route('storePaketMember') }}" method="post">
    ...
    <div class="form-group">
        ...
        <input type="text" name="package_name" id="package_name" class="form-control" required="required"
            placeholder="Masukkan nama paket">
    </div>

    <div class="form-group">
        <label for="durasi">Durasi</label>
        <input type="text" name="days" id="days" class="form-control" required="required"
            placeholder="Masukkan durasi">
    </div>

    <div class="form-group">
        <label for="harga-paket">Harga Paket</label>
        <input type="number" name="package_price" id="package_price" class="form-control" required="required"
            placeholder="Masukkan harga paket">
    </div>

    <div class="form-group">
        <label for="biaya-admin">Biaya Admin</label>
        <input type="number" name="admin_price" id="package_price" class="form-control" required="required"
