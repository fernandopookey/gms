...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('home') }}" class="nav-link">Omah</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="{{ route('logout') }}"
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item {{ request()->is('daftarKategori*') ? 'menu-open' : '' }}">
                                    <a href="{{ route('daftarKategori') }}" class="nav-link">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Daftar Kategori</p>
                                    </a>
                                </li>
                                <li class="nav-item {{ request()->is('daftarArtikel*') ? 'menu-open' : '' }}">
        ...
        <script>
            ...
            // Loop melalui setiap tautan di menu
            var navLinks = document.querySelectorAll('.nav-link');
            navLinks.forEach(function(navLink) {
                // Jika URL saat ini cocok dengan href dari tautan, tambahkan kelas 'active'
                if (navLink.href === currentUrl) {
                    navLink.classList.add('active');

                    // Jika tautan berada dalam submenu, tambahkan kelas 'menu-open' pada elemen li parent
